""" main.py
Main file for drone control by gaze estimation.
Procedure:
    * generates neural networks for face and gaze detection
    * camera connexion
    * drone connection and take off
    * while user does not quit:
        ...
        ** if gaze detected and delay exceeded:
            ...
            *** sends movement command for corresponding direction
...
def moveUp(drone: Tello):
    """ Function moveUp.
        ...
        MAX_HEIGHT = 180cm
    """
    if (drone.get_height() < 180): # drone height less than 180cm
        drone.move_up(20)
    else:
...
def moveDown(drone: Tello):
    """ Function moveDown.
        ...
        MIN_HEIGHT = 30cm
    """
    if (drone.get_height() > 30): # drone height greater than 30cm
        drone.move_down(20)
    else:
...
with dai.Device(pipeline) as device:
    ...
    while True:
        ...
        if frame is not None:
            ...
            cv2.putText(frame, f"Battery: {drone_battery}", (30,200), textFont, textFontScale, textColor, textThickness)
            cv2.putText(frame, text_error, (30,250), textFont, textFontScale, textColor, textThickness)
